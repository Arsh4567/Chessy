      ...
      <div className="bg-slate-900 border border-slate-800 p-3 sm:p-4 rounded-2xl shadow-md space-y-3">
        ...
        >
          ...
          <button
            ...
            className="px-5 py-2.5 bg-amber-500 hover:bg-amber-400 disabled:opacity-50 text-slate-950 font-bold text-xs sm:text-sm rounded-xl transition-all cursor-pointer flex items-center justify-center gap-2 shrink-0 shadow-md"
          >
            {loading ? (
              <>
        ...
        <div className="flex flex-wrap items-center gap-1.5 pt-1">
          ...
          {POPULAR_PLAYERS.map((u) => (
            <button
              ...
              className="px-2.5 py-1 rounded-lg text-[11px] font-mono font-medium bg-slate-950 border border-slate-800 text-slate-400 hover:text-amber-400 hover:border-slate-700 transition-colors cursor-pointer"
            >
              {u}
            </button>
          ))}
            ...
            <div className="flex items-center gap-2">
              {onOpenReport && games.length > 0 && (
                <button
                  ...
                  className="px-3 py-1.5 bg-amber-500 hover:bg-amber-400 text-slate-950 text-xs font-bold rounded-xl transition-all shadow cursor-pointer flex items-center gap-1.5"
                >
              ...
              <button
                ...
                disabled={loading}
                className="text-xs text-slate-400 hover:text-amber-400 flex items-center gap-1 transition-colors cursor-pointer px-2 py-1.5 rounded-lg hover:bg-slate-800"
              >
                ...
                >
                  <div className="flex items-start gap-3 min-w-0">
                    ...
                    <div className="min-w-0 space-y-0.5">
                      ...
                      <div className="text-[11px] text-slate-400 font-mono truncate">
                        {g.openingName ? (
                          <span className="text-amber-400/90 mr-2">{g.openingName}</span>
                        ) : null}
                  ...
                  <div className="flex items-center gap-2 self-end sm:self-center shrink-0">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-amber-500 hover:bg-amber-400 text-slate-950 text-xs font-bold rounded-lg transition-all shadow cursor-pointer flex items-center gap-1.5"
                    >
